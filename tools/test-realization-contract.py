...
base = {
    "world": {"entities": [{"id": "woman", "label": "woman", "attributes": ["red coat"]}], "visualIdentity": {"color": {"scheme": "complementary", "temperature": 0.7, "accentWeight": 0.4}, "lighting": {"direction": "side", "warmth": 0.8, "atmosphere": 0.5}}},
